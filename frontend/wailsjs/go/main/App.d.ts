...
export function CheckDuplicates(arg1:string,arg2:Array<string>):Promise<imghash.DuplicateReport>;
...
export function DismissDuplicatePair(arg1:string,arg2:string,arg3:string):Promise<void>;
