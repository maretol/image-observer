...
- [ ] **画像サンプルモーダルと編集ペインの統合 (#93)**: SampleModal と EditPopover を 1 モーダルに統合し、プレビューを見ながら tags/confidence/note を編集できるようにする。Phase 1 は横並び 2 ペイン + 明示保存維持 + 未保存中 prev/next 抑止。 → [spec-sample-modal-edit.md](spec-sample-modal-edit.md)
